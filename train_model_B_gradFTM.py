...
Description
-----------
Training of the modelB using the High Frequencies inside the perceptual loss. 
...
def train_step(model: torch.nn.Module, 
    ...
    for _, data in enumerate(pbar): 
        ...
        lst_SR_low_freq = us.get_output_ftm(lst_SR, mtf = 0.25)
        ndvi_low_freq = us.get_output_ftm(ndvi, mtf = 0.25)
        
        grads_lst = lst_SR - lst_SR_low_freq
        grads_ndvi = ndvi - ndvi_low_freq
