...
Description
-----------
File containing the definition of the LPIPS loss function / deep similarity metric.
The code was obtained from the piq library: 
...
def reduce(x: torch.Tensor, reduction: str = 'mean') -> torch.Tensor:
...
class ContentLoss(_Loss):
    ...
    def forward(self, x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
        ...
        """
        validate_input([x, y], dim_range=(4, 4), data_range=(0, -1))
